...
public class Controller_Vending{
    ...
    public static void main(String[] args) {
        ...
        System.out.println("[1] Use Regular Vending Machine");
        System.out.println("[2] Use Special Vending Machine");
        ...
        switch (nChoice) {
            ...
            case 1: session.updateInventory();
                    session.RegularVendMenu(scan);
                break;
            case 2: specialSession.SpecialVendMenu();
                break;
            case 3: session.maintenanceMenu(scan);
                break;
            case 4: bmainContinue = false;
