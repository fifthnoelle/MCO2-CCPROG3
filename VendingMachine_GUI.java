 ...
 * @author rdpun
 */
public class VendingMachine_GUI extends javax.swing.JFrame {
     ...
     */
    public VendingMachine_GUI(ArrayList<items> itemSlots) {
    ...
    private void MaintenanceBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MaintenanceBtnActionPerformed
        new Maintenance_GUI(itemSlots, moneyBank).setVisible(true);
